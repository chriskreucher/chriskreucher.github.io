...
==========================
* KBR Techncial Journal Paper Selections 2021...2025 [2025](https://techjournal.kbr.com/), [2024](https://techjournal.kbr.com/), [2023](https://kbr.foleon.com/kbr-tech-journal/2023/) for papers "A Multi-view CNN for SAR ATR" (2025), "Improving Synthetic Aperture Radar (SAR) Automatic Target Recognition (ATR) Using Synthetic Data via Transfer Learning" (2023), "An Evaluation of Task and Information Driven Approaches for Radar Resource Allocation" (2021), "Implementing Perception-Action Cycles Using Stochastic Optimization" (2021)
* Centauri Gold Medal Paper Award, 2020 for paper "A Hybrid Template / Deep Learning Approach to SAR ATR" 
* Centauri Technical Journal Paper Selection for paper "An Information Theoretic Radar Tracker Performance Model" (2019)
* IAI Technical Journal Paper Selections 2011...2018 for papers "A Geodesic Flow Particle Filter for Non-Thresholded Measurements" (2018), "Complex Input Convolutional Neural Network Features for Wide Angle SAR ATR" (2016), "Optimal Exploitation of Fluctuating Target Measurements" (2016), "Modern Approaches in Deep Learning for SAR ATR" (2015), "A Comparison of Tracking Algorithms for Supermaneuverable Targets" (2015), "Performance of Maximum Likelihood Estimation for Passive Ranging in Multipath" (2014), "CRB-Optimal Sensor Placement for Multiple Passive Acoustic Arrays" (2013), "Optimal Fusion of Video and RF Data for Detection and Tracking with Object Occlusion" (2012), "A Compressive Sensing Approach to Multistatic Radar Change Imaging" (2012), "A Fuse-Before-Track Approach to Target State Estimation Using Passive Acoustic Sensors" (2011), "Exploiting Narrowband Bistatic Radar Measurements for Dismount Detection and Tracking" (2011)
