...
def populate_header( nm, f, unique_years, unique_types):
    ...
    if nm in unique_types:
        f.write('\n<a href="../complete-bibliography/"><button type="button" class="btn" style="color:#000000;background-color:#5C5C5C;outline:none;border-radius:5px"> all </button></a>')        
    else:
    ...
    for typ in unique_types:
        if typ == nm:
            f.write('\n<a href="../' + typ + '/"><button type="button" class="button button3" style="background-color:#000000;color:#5C5C5C;outline:none;border-radius:5px"> ' + typ + '</button></a>')
        else:
            f.write('\n<a href="../' + typ + '/"><button type="button" class="btn" style="color:#000000;background-color:#5C5C5C;outline:none;border-radius:5px"> ' + typ + '</button></a>')
    f.write('\n</center>')
    ...
    for year in unique_years:
        if i==math.ceil( len(unique_years)/3 ) :
            ...
            i=0
        if year == nm:
            f.write('\n<a href="../' + year + '/"><button type="button" class="button button3" style="background-color:#000000;color:#5C5C5C;outline:none;border-radius:5px"> ' + year + '</button></a>')
        else:
            f.write('\n<a href="../' + year + '/"><button type="button" class="btn" style="color:#000000;background-color:#5C5C5C;outline:none;border-radius:5px"> ' + year + '</button></a>')
        i=i+1
    f.write("\n<br><br>")
    f.write('\n</center>')
